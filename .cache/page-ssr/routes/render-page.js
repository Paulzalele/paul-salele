...
var _react = _interopRequireDefault(__webpack_require__(6283));
...
var React = _interopRequireWildcard(__webpack_require__(6283));
...
var _react = __webpack_require__(6283);
...
exports.components={"component---cache-caches-gatsby-plugin-offline-app-shell-js":()=>__webpack_require__.e(/* import() | component---cache-caches-gatsby-plugin-offline-app-shell-js */ 306).then(__webpack_require__.bind(__webpack_require__, 1930)),"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 9616)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 3788)),"component---src-pages-page-2-js":()=>__webpack_require__.e(/* import() | component---src-pages-page-2-js */ 617).then(__webpack_require__.bind(__webpack_require__, 9863))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(9814),options:{"plugins":[]}},{name:'gatsby-plugin-image',plugin:__webpack_require__(573),options:{"plugins":[]}},{name:'gatsby-plugin-matomo',plugin:__webpack_require__(6421),options:{"plugins":[],"siteId":"1","matomoUrl":"https://paulsalele.matomo.cloud/","siteUrl":"https://paulsalele.com"}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(341),options:{"plugins":[],"name":"Paul Salele","short_name":"Paul Salele","start_url":"https://paulsalele.com","background_color":"#663399","theme_color":"#663399","display":"standalone","icon":"src/images/phoenix-icon.png","crossOrigin":"use-credentials","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","include_favicon":true,"cacheDigest":"36e8e94ce1add6166288e20f01a4dc58"}},{name:'gatsby-plugin-offline',plugin:__webpack_require__(2100),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);var React=_interopRequireWildcard(__webpack_require__(6283));var _gatsby=__webpack_require__(2031);var _common=__webpack_require__(8108);var _getManifestPathname=_interopRequireDefault(__webpack_require__(1632));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);exports.__esModule=true;exports.onRenderBody=void 0;var _react=_interopRequireDefault(__webpack_require__(6283));// eslint-disable-next-line no-unused-vars
function buildTrackingCode(pluginOptions){var matomoUrl=pluginOptions.matomoUrl,_pluginOptions$matomo=pluginOptions.matomoPhpScript,matomoPhpScript=_pluginOptions$matomo===void 0?'piwik.php':_pluginOptions$matomo,_pluginOptions$matomo2=pluginOptions.matomoJsScript,matomoJsScript=_pluginOptions$matomo2===void 0?'piwik.js':_pluginOptions$matomo2,siteId=pluginOptions.siteId,dev=pluginOptions.dev,localScript=pluginOptions.localScript,requireConsent=pluginOptions.requireConsent,requireCookieConsent=pluginOptions.requireCookieConsent,disableCookies=pluginOptions.disableCookies,cookieDomain=pluginOptions.cookieDomain,enableJSErrorTracking=pluginOptions.enableJSErrorTracking,_pluginOptions$respec=pluginOptions.respectDnt,respectDnt=_pluginOptions$respec===void 0?true:_pluginOptions$respec;var script=localScript?localScript:matomoUrl+"/"+matomoJsScript;var dntCondition=respectDnt?"!(navigator.doNotTrack === '1' || window.doNotTrack === '1')":"true";var html="\n    window.dev = "+dev+"\n    if (window.dev === true || "+dntCondition+") {\n      window._paq = window._paq || [];\n      "+(requireConsent?"window._paq.push(['requireConsent']);":'')+"\n      "+(requireCookieConsent?"window._paq.push(['requireCookieConsent']);":'')+"\n      "+(disableCookies?"window._paq.push(['disableCookies']);":'')+"\n      "+(enableJSErrorTracking?"window._paq.push(['enableJSErrorTracking']);":'')+"\n      "+(cookieDomain?"window._paq.push(['setCookieDomain', '"+cookieDomain+"']);":'')+"\n      window._paq.push(['setTrackerUrl', '"+matomoUrl+"/"+matomoPhpScript+"']);\n      window._paq.push(['setSiteId', '"+siteId+"']);\n      window._paq.push(['enableHeartBeatTimer']);\n      window.start = new Date();\n\n      (function() {\n        var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0];\n        g.type='text/javascript'; g.async=true; g.defer=true; g.src='"+script+"'; s.parentNode.insertBefore(g,s);\n      })();\n\n      if (window.dev === true) {\n        console.debug('[Matomo] Tracking initialized')\n        console.debug('[Matomo] matomoUrl: "+matomoUrl+", siteId: "+siteId+"')\n      }\n    }\n  ";return/*#__PURE__*/_react.default.createElement("script",{key:"script-gatsby-plugin-matomo",dangerouslySetInnerHTML:{__html:html}});}function buildTrackingCodeNoJs(pluginOptions,pathname){var matomoUrl=pluginOptions.matomoUrl,_pluginOptions$matomo3=pluginOptions.matomoPhpScript,matomoPhpScript=_pluginOptions$matomo3===void 0?'piwik.php':_pluginOptions$matomo3,siteId=pluginOptions.siteId,siteUrl=pluginOptions.siteUrl;var html="<img src=\""+matomoUrl+"/"+matomoPhpScript+"?idsite="+siteId+"&rec=1&url="+(siteUrl+pathname)+"\" style=\"border:0\" alt=\"tracker\" />";return/*#__PURE__*/_react.default.createElement("noscript",{key:"noscript-gatsby-plugin-matomo",dangerouslySetInnerHTML:{__html:html}});}function buildHead(pluginOptions){return/*#__PURE__*/_react.default.createElement("link",{rel:"preconnect",href:pluginOptions.matomoUrl,key:"preconnect-gatsby-plugin-matomo"});}var onRenderBody=function onRenderBody(_ref,pluginOptions){var setHeadComponents=_ref.setHeadComponents,setPostBodyComponents=_ref.setPostBodyComponents,pathname=_ref.pathname;var isProduction="production"==='production';var excludePaths=['/offline-plugin-app-shell-fallback/'];if(pluginOptions&&typeof pluginOptions.exclude!=='undefined'){pluginOptions.exclude.map(function(exclude){excludePaths.push(exclude);});}var isPathExcluded=excludePaths.some(function(path){return pathname===path;});if((isProduction||pluginOptions&&pluginOptions.dev===true)&&!isPathExcluded){setHeadComponents([buildHead(pluginOptions)]);setPostBodyComponents([buildTrackingCode(pluginOptions),buildTrackingCodeNoJs(pluginOptions,pathname)]);}};exports.onRenderBody=onRenderBody;
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6283);
...
var React = __webpack_require__(6283);
...
"use strict";
module.exports = require("/Users/owner/paul-salele/frontend/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/owner/paul-salele/frontend/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/owner/paul-salele/frontend/node_modules/react/index.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-65a907e51915b8b71475.js"],"app":["/app-c01a273ab37fa900515d.js"],"component---cache-caches-gatsby-plugin-offline-app-shell-js":["/component---cache-caches-gatsby-plugin-offline-app-shell-js-ca7625a901b217b3cc85.js"],"component---src-pages-404-js":["/component---src-pages-404-js-b9c73eb3040053d5ad0e.js"],"component---src-pages-index-js":["/component---src-pages-index-js-74a250644da3afa28fce.js"],"component---src-pages-page-2-js":["/component---src-pages-page-2-js-43b778637abe228439c4.js"]}');
